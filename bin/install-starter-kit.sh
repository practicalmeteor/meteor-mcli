...
sudo curl -L -o /tmp/mcli.tar.gz https://github.com/practicalmeteor/meteor-mcli/archive/master.tar.gz
...
cp -r /tmp/meteor-mcli-master/starter-mcli-app .
sudo rm -rf /tmp/mcli.tar.gz /tmp/meteor-mcli-master
echo "A starter meteor command line program using practicalmeteor:mcli was created in your current directory."
echo "To run your new meteor command line program:"
echo "  cd starter-mcli-app"
